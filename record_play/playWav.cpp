...
int main(int argc, char **argv)
{
	...
	const ALCchar *defaultDeviceName = 0;//argv[1];
	int ret;
#ifdef LIBAUDIO
	WaveInfo *wave;
#endif
...
#else
	alutLoadWAVFile((ALbyte*)argv[1], &format, &data, &size, &freq, &loop);
	...
	extractWavData((char*)data, sizeInBytes);
